...
global.github = 'https://github.com/Dineshkumarachanaka/CHANU-MD-v1'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.devs = '94761438198';
global.website = 'https://github.com/Dineshkumarachanaka/CHANU-MD-v1' //wa.me/+94761438198
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'CHANU-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94761438198',
  alivepic: process.env.ALIVE_IMG || 'https://telegra.ph/file/d2e43e0b7e028a334be7a.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY CHANU-MD* 🎊',
  ownername:process.env.OWNER_NAME || 'CHANU',
